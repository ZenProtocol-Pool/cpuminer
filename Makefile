...
am_minerd_OBJECTS = minerd-cpu-miner.$(OBJEXT) minerd-util.$(OBJEXT) \
	...
	minerd-keccak.$(OBJEXT) minerd-zenprotocol.$(OBJEXT)
...
LDFLAGS = 
LIBCURL = -L/c/msys64/mingw64/lib -lcurl -lssh2 -lssl -lcrypto -lgdi32 -lssl -lcrypto -lwldap32 -lz -lws2_32
LIBCURL_CPPFLAGS = -I/c/msys64/mingw64/include
LIBOBJS = 
LIBS = -lcrypto -lssl 
LTLIBOBJS = 
MAINT = #
...
WS2_LIBS = -lws2_32
_libcurl_config = 
abs_builddir = /home/HP USER/cpuminer
abs_srcdir = /home/HP USER/cpuminer
abs_top_builddir = /home/HP USER/cpuminer
abs_top_srcdir = /home/HP USER/cpuminer
ac_ct_CC = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} '/home/HP USER/cpuminer/install-sh'
...
minerd_SOURCES = elist.h miner.h compat.h \
		  ...
		  keccak.c zenprotocol.c

minerd_LDFLAGS = $(PTHREAD_FLAGS)
minerd_LDADD = -L/c/msys64/mingw64/lib -lcurl -lssh2 -lssl -lcrypto -lgdi32 -lssl -lcrypto -lwldap32 -lz -lws2_32 -ljansson -lpthread -lws2_32
minerd_CPPFLAGS = -I/c/msys64/mingw64/include
...
include ./$(DEPDIR)/minerd-zenprotocol.Po
...
minerd-zenprotocol.o: zenprotocol.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-zenprotocol.o -MD -MP -MF $(DEPDIR)/minerd-zenprotocol.Tpo -c -o minerd-zenprotocol.o `test -f 'zenprotocol.c' || echo '$(srcdir)/'`zenprotocol.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-zenprotocol.Tpo $(DEPDIR)/minerd-zenprotocol.Po
#	$(AM_V_CC)source='zenprotocol.c' object='minerd-zenprotocol.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-zenprotocol.o `test -f 'zenprotocol.c' || echo '$(srcdir)/'`zenprotocol.c

minerd-zenprotocol.obj: zenprotocol.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-zenprotocol.obj -MD -MP -MF $(DEPDIR)/minerd-zenprotocol.Tpo -c -o minerd-zenprotocol.obj `if test -f 'zenprotocol.c'; then $(CYGPATH_W) 'zenprotocol.c'; else $(CYGPATH_W) '$(srcdir)/zenprotocol.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-zenprotocol.Tpo $(DEPDIR)/minerd-zenprotocol.Po
#	$(AM_V_CC)source='zenprotocol.c' object='minerd-zenprotocol.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-zenprotocol.obj `if test -f 'zenprotocol.c'; then $(CYGPATH_W) 'zenprotocol.c'; else $(CYGPATH_W) '$(srcdir)/zenprotocol.c'; fi`
